...
import com.allenai.ml.sequences.crf.CRFFeatureEncoder;
import com.allenai.ml.sequences.crf.CRFModel;
import com.allenai.ml.sequences.crf.CRFPredicateExtractor;
import com.allenai.ml.sequences.crf.CRFWeightsEncoder;
...
public class ConllFormat {
    ...
    public static void saveModel(DataOutputStream dos,
                                 ...
                                 CRFFeatureEncoder<String, ConllFormat.Row, String> featureEncoder,
    ...
    public static CRFModel<String, ConllFormat.Row, String> loadModel(DataInputStream dis) throws IOException {
